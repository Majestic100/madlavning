...
instructions:
  ...
  - group: "På bagedagen"
    steps:
      ...
      - text: "Sæt snurrerne på bageplader med god afstand. Lad dem efterhæve tildækket i 60–90 minutter ved stuetemperatur — de skal blive tydeligt puffede."
      - text: "Forvarm ovnen til 200 °C almindelig varme. Pensl med sammenpisket æg og mælk, og drys med perlesukker."
      - text: "Bag i 12–14 minutter, til de er dybt gyldne. Tag dem ud, mens midten stadig er en anelse blød — de efterbager på pladen."
tips:
  - "Kardemommen skal helst være friskstødt. Køb hele kapsler og knus frøene i en morter — du får dobbelt så meget duft ud af det samme gram."
  - "Er remoncen for blød, når du ruller, løber den ud i ovnen. Stil den 10 minutter på køl, hvis dit køkken er varmt."
  - "Snurrer bliver tørre i køleskabet. Frys dem i stedet — 4 minutter ved 180 °C, og de er som nybagte."
...
dagen efter. Forskellen ligger sjældent i opskriften — den ligger i tiden.

Den her dej står på køl natten over. Ikke fordi det er smart planlægning, men fordi gæren
arbejder langsomt og laver smag, når den har det køligt. Bager du dejen samme dag, får du
en fin bolle. Bager du den dagen efter, får du noget, der smager af bageri.

Det var min svigermors kommentar — *"de smager jo som fra en rigtig bager"* — der fik mig
til at skrive opskriften ned præcis, som jeg laver den. Så her er den, i gram og med alle
de detaljer, jeg selv ledte efter, da jeg lærte det.
