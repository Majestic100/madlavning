...
author: merve
image:
  src: ../../assets/opskrifter/pannacotta-med-hindbaer.jpg
  alt: "Panna cotta i glas med klar rød hindbærsauce og friske hindbær på toppen"
prepTime: 15
cookTime: 10
waitTime: 240
servings: 6
...
ingredients:
  - group: "Panna cotta"
    items:
      - { amount: 5, unit: "dl", name: "piskefløde" }
      - { amount: 70, unit: "g", name: "sukker" }
      - { amount: 1, unit: "stk", name: "vaniljestang", note: "eller 2 tsk vaniljesukker" }
      - { amount: 2.5, unit: "stk", name: "husblasblade" }
  - group: "Hindbærsauce"
    items:
      - { amount: 250, unit: "g", name: "hindbær", note: "friske eller frosne" }
      - { amount: 50, unit: "g", name: "sukker" }
      - { amount: 0.5, unit: "stk", name: "citron", note: "kun saften" }
instructions:
  - group: "Panna cotta"
    steps:
      - text: "Læg husblassen i blød i rigeligt koldt vand i mindst 5 minutter."
      - text: "Flæk vaniljestangen, skrab kornene ud, og giv fløde, sukker, korn og stang et opkog. Tag gryden af varmen, så snart den koger."
      - text: "Fisk vaniljestangen op. Knug vandet af husblassen, og rør den ud i den varme fløde, til den er helt opløst."
      - text: "Fordel blandingen i 6 glas eller forme, lad dem køle af, og stil dem på køl i mindst 4 timer."
  - group: "Hindbærsauce"
    steps:
