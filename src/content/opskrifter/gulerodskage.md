...
author: merve
image:
  src: ../../assets/opskrifter/gulerodskage.jpg
  alt: "Stykke gulerodskage med tyk flødeostecreme og hakkede valnødder"
prepTime: 30
cookTime: 40
waitTime: 120
servings: 15
...
ingredients:
  - group: "Kagen"
    items:
      - { amount: 300, unit: "g", name: "gulerødder", note: "fintrevne" }
      - { amount: 3, unit: "stk", name: "æg" }
      - { amount: 200, unit: "g", name: "sukker" }
      - { amount: 100, unit: "g", name: "brun farin" }
      - { amount: 200, unit: "g", name: "smagsneutral olie" }
      - { amount: 250, unit: "g", name: "hvedemel" }
      - { amount: 10, unit: "g", name: "bagepulver" }
      - { amount: 5, unit: "g", name: "natron" }
      - { amount: 8, unit: "g", name: "stødt kanel" }
      - { amount: 2, unit: "g", name: "stødt ingefær" }
      - { amount: 4, unit: "g", name: "fint salt" }
      - { amount: 100, unit: "g", name: "valnødder", note: "groft hakkede" }
  - group: "Flødeostecreme"
    items:
      - { amount: 200, unit: "g", name: "flødeost", note: "naturel, kold" }
      - { amount: 100, unit: "g", name: "smør", note: "blødt" }
      - { amount: 150, unit: "g", name: "flormelis" }
      - { amount: 1, unit: "tsk", name: "vaniljesukker" }
      - { amount: 0.5, unit: "stk", name: "citron", note: "kun fintrevet skal" }
instructions:
  - group: "Kagen"
    steps:
