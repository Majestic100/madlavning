...
author: merve
image:
  src: ../../assets/opskrifter/pizza-bianca.jpg
  alt: "Pizza bianca med gyldne kartoffelskiver, rosmarin og smeltet ost"
prepTime: 30
cookTime: 8
waitTime: 0
servings: 2
...
ingredients:
  - group: "Pizza"
    items:
      - { amount: 2, unit: "stk", name: "pizzadejskugler", note: "se min koldhævede pizzadej" }
      - { amount: 300, unit: "g", name: "små faste kartofler" }
      - { amount: 125, unit: "g", name: "frisk mozzarella", note: "drænet og plukket" }
      - { amount: 40, unit: "g", name: "revet parmesan" }
      - { amount: 2, unit: "kvist", name: "frisk rosmarin" }
      - { amount: 2, unit: "spsk", name: "olivenolie" }
